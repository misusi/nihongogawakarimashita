...
LINK          = g++
LFLAGS        = -fPIC
LIBS          = $(SUBLIBS) -L/home/misusi/Desktop/dev/qt/buffaloshittranslator/../../../../../../usr/lib/ -lxml2 /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Network.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
